...
const DELAY_COLOR_EXPRESSION: ExpressionSpecification = [
  "interpolate",
  ["linear"],
...
const BASE_LINE_WIDTH_EXPRESSION: ExpressionSpecification = [
  "interpolate",
  ["linear"],
  ["zoom"],
  11,
...
const HEAT_LINE_WIDTH_EXPRESSION: ExpressionSpecification = [
  "interpolate",
  ["linear"],
  ["zoom"],
  11,
